...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed max-w-screen  overflow-hidden  top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-gray-900/95 shadow-lg' : 'bg-transparent'}`}>
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="md:hidden">
            <button 
              ...
              className="inline-flex items-center justify-center p-2 pr-4 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none"
            >
